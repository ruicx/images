...
directory/name equality, duplicate variants, secret-like build arguments, dependency targets,
duplicate context names, smoke tests, graph cycles, and bilingual documentation.
